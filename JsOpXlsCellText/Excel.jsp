...
<script type="text/javascript">
    function setCellValue(sheet, cell, value) {
        poapplication.Sheets.get_Item(sheet).get_Range(cell).put_Value2(value);
    }

    function getCellValue(sheet, cell) {
      var cellValue= poapplication.Sheets.get_Item(sheet).get_Range(cell).get_Value();
      return cellValue;
    }

    function Button1_onclick() {
      alert(getCellValue("Sheet1", "B4")) ;
    }
