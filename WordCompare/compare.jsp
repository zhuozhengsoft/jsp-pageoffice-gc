...
<script language="javascript" type="text/javascript">
        function ShowFile1View() {
	        poapplication.ActiveDocument.ActiveWindow.View.ShowRevisionsAndComments = false;
            poapplication.ActiveDocument.ActiveWindow.View.RevisionsView = 1;
	    }
	    function ShowFile2View() {
            poapplication.ActiveDocument.ActiveWindow.View.ShowRevisionsAndComments = false;
            poapplication.ActiveDocument.ActiveWindow.View.RevisionsView = 0;
	    }
	    function ShowCompareView() {
            poapplication.ActiveDocument.ActiveWindow.View.ShowRevisionsAndComments = true;
            poapplication.ActiveDocument.ActiveWindow.View.RevisionsView = 0;
	    }
